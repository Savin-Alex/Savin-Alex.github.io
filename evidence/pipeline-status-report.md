...
## Кратко
Управляемый AI-assisted delivery: Jira-задача → план → код → sandbox-проверка → ревью человека → GitHub PR. Цель — показать GenAI в delivery как контролируемый процесс, а не «автогенерацию кода».
